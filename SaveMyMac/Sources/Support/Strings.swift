...
enum Strings {
    ...
    static let pt: [String: String] = [
        ...
        // ── Cleanup risk ────────────────────────────────────────────────────
        "Caution": "Atenção",
        "%d file · click to filter": "%d arquivo · clique para filtrar",
        "%d files · click to filter": "%d arquivos · clique para filtrar",
        "This volume": "Este volume",
        "cloud providers": "provedores de nuvem",
        "Mail": "o Mail",
        "Messages": "o Mensagens",
        "group containers": "containers de grupo",
        "sandboxed app containers": "containers de apps sandboxados",
        "Looking for other large folders…": "Procurando outras pastas grandes…",
        "Checking source and destination…": "Verificando origem e destino…",
        "Copying %@…": "Copiando %@…",
        "%d file could not be read in the source, so the copy could not be verified. Nothing was moved.": "%d arquivo não pôde ser lido na origem, então a cópia não pôde ser verificada. Nada foi movido.",
        "%d files could not be read in the source, so the copy could not be verified. Nothing was moved.": "%d arquivos não puderam ser lidos na origem, então a cópia não pôde ser verificada. Nada foi movido.",
        "Checking %d files…": "Conferindo %d arquivos…",
        "Publishing to the destination…": "Publicando no destino…",
        "Testing reading and writing through the link…": "Testando leitura e escrita pelo link…",
        "Could not write the migration journal — nothing was moved. Check the disk.": "Não foi possível gravar o diário de migração — nada foi movido. Verifique o disco.",
        "Failed to publish AND the original could not be put back. It is safe in quarantine: %@": "Falhou ao publicar E o original não pôde voltar ao lugar. Ele está seguro na quarentena: %@",
        "Failed to create the link AND the original could not be put back. It is safe in quarantine: %@": "Falhou ao criar o link E o original não pôde voltar ao lugar. Ele está seguro na quarentena: %@",
        "The link failed the test AND the original could not be put back. It is safe in quarantine: %@": "O link falhou no teste E o original não pôde voltar ao lugar. Ele está seguro na quarentena: %@",
        "The old copy could not be moved to the Trash and is still at %@.": "A cópia antiga não pôde ir para a Lixeira e continua em %@.",
        "cleanup": "limpeza",
        "trash": "lixeira",
        "app cache": "cache de app",
        "offload": "offload",
        "Path protected by the system": "Caminho protegido pelo sistema",
        "Outside the allowed scope": "Fora do escopo permitido",
        "The destination cannot be inside the source itself.": "O destino não pode estar dentro da própria origem.",
        "The source cannot be inside the destination.": "A origem não pode estar dentro do destino.",
        "Nothing to remove.": "Nada a remover.",
        ...
        "Starting…": "Iniciando…",
        "Cancelled": "Cancelada",
        "Emptying the Trash…": "Esvaziando a Lixeira…",
        "Removing %@…": "Removendo %@…",
        "Checking %@…": "Conferindo %@…",
        "Clearing %@…": "Limpando %@…",
        "Uninstalling %@…": "Desinstalando %@…",
        "Rolling back %@…": "Revertendo %@…",
        "Releasing %d quarantine…": "Liberando %d quarentena…",
        "Releasing %d quarantines…": "Liberando %d quarentenas…",
        "Releasing %@…": "Liberando %@…",
        "Downloaded %@": "Baixado %@",
        "Safe": "Seguro",
        "Review": "Revisar",
        "Replace soon": "Substituir em breve",
        "Good": "Boa",
        "Normal": "Normal",
        "No battery (desktop)": "Sem bateria (desktop)",
        "Charging": "Carregando",
        "Plugged in": "Na tomada",
        "On battery": "Na bateria",
        "%@ was quit.": "%@ foi encerrado.",
        "Checking": "Verificando",
        "Copying": "Copiando",
        "Failed": "Falhou",
        ...
        "Checking folder access…": "Verificando o acesso às pastas…",
        "The scan probably did not see everything": "A varredura provavelmente não viu tudo",
        "The scan walked only %d files in your whole home folder. That is far fewer than a Mac in use contains, so the result below is incomplete rather than clean.": "A varredura percorreu só %d arquivos em toda a sua pasta pessoal. É muito menos do que um Mac em uso contém, então o resultado abaixo está incompleto, não limpo.",
        "denied by macOS": "negada pelo macOS",
        "came back empty — cannot tell denial from an empty folder": "voltou vazia — não é possível distinguir bloqueio de pasta vazia",
        "Full Disk Access: not granted": "Acesso Total ao Disco: não concedido",
        "Without Full Disk Access, macOS hides Desktop, Documents, Downloads, Movies, Music, Pictures and Library — which is exactly where large files live. It does this silently, returning empty folders rather than errors.": "Sem Acesso Total ao Disco, o macOS esconde Mesa, Documentos, Downloads, Filmes, Música, Imagens e Library — que é justamente onde os arquivos grandes ficam. E faz isso em silêncio, devolvendo pastas vazias em vez de erros.",
        "These folders returned nothing and may be blocked: %@.": "Estas pastas não devolveram nada e podem estar bloqueadas: %@.",
        "Backups": "Backups",
        "Images": "Imagens",
    ...
    static let es: [String: String] = [
        ...
        // ── Cleanup risk ────────────────────────────────────────────────────
        "Caution": "Atención",
        "%d file · click to filter": "%d archivo · clic para filtrar",
        "%d files · click to filter": "%d archivos · clic para filtrar",
        "This volume": "Este volumen",
        "cloud providers": "proveedores de nube",
        "Mail": "Mail",
        "Messages": "Mensajes",
        "group containers": "contenedores de grupo",
        "sandboxed app containers": "contenedores de apps en sandbox",
        "Looking for other large folders…": "Buscando otras carpetas grandes…",
        "Checking source and destination…": "Comprobando origen y destino…",
        "Copying %@…": "Copiando %@…",
        "%d file could not be read in the source, so the copy could not be verified. Nothing was moved.": "%d archivo no pudo leerse en el origen, así que la copia no pudo verificarse. No se movió nada.",
        "%d files could not be read in the source, so the copy could not be verified. Nothing was moved.": "%d archivos no pudieron leerse en el origen, así que la copia no pudo verificarse. No se movió nada.",
        "Checking %d files…": "Comprobando %d archivos…",
        "Publishing to the destination…": "Publicando en el destino…",
        "Testing reading and writing through the link…": "Probando lectura y escritura a través del enlace…",
        "Could not write the migration journal — nothing was moved. Check the disk.": "No se pudo escribir el diario de migración — no se movió nada. Revisa el disco.",
        "Failed to publish AND the original could not be put back. It is safe in quarantine: %@": "Falló la publicación Y el original no pudo volver a su lugar. Está a salvo en cuarentena: %@",
        "Failed to create the link AND the original could not be put back. It is safe in quarantine: %@": "Falló la creación del enlace Y el original no pudo volver a su lugar. Está a salvo en cuarentena: %@",
        "The link failed the test AND the original could not be put back. It is safe in quarantine: %@": "El enlace falló la prueba Y el original no pudo volver a su lugar. Está a salvo en cuarentena: %@",
        "The old copy could not be moved to the Trash and is still at %@.": "La copia antigua no pudo ir a la Papelera y sigue en %@.",
        "cleanup": "limpieza",
        "trash": "papelera",
        "app cache": "caché de app",
        "offload": "descarga",
        "Path protected by the system": "Ruta protegida por el sistema",
        "Outside the allowed scope": "Fuera del ámbito permitido",
        "The destination cannot be inside the source itself.": "El destino no puede estar dentro del propio origen.",
        "The source cannot be inside the destination.": "El origen no puede estar dentro del destino.",
        ...
        "Starting…": "Iniciando…",
        "Cancelled": "Cancelado",
        "Emptying the Trash…": "Vaciando la Papelera…",
        "Removing %@…": "Eliminando %@…",
        "Checking %@…": "Comprobando %@…",
        "Clearing %@…": "Limpiando %@…",
        "Uninstalling %@…": "Desinstalando %@…",
        "Rolling back %@…": "Revirtiendo %@…",
        "Releasing %d quarantine…": "Liberando %d cuarentena…",
        "Releasing %d quarantines…": "Liberando %d cuarentenas…",
        "Releasing %@…": "Liberando %@…",
        "Downloaded %@": "Descargado %@",
        "Safe": "Seguro",
        "Review": "Revisar",
        "Replace soon": "Sustituir pronto",
        "Good": "Buena",
        "Normal": "Normal",
        "No battery (desktop)": "Sin batería (escritorio)",
        "Charging": "Cargando",
        "Plugged in": "Enchufado",
        "On battery": "Con batería",
        "%@ was quit.": "%@ fue cerrado.",
        "Checking": "Comprobando",
        "Copying": "Copiando",
        "Failed": "Falló",
        "Rolled back": "Revertido",
        ...
        "Checking folder access…": "Comprobando el acceso a las carpetas…",
        "The scan probably did not see everything": "El análisis probablemente no lo vio todo",
        "The scan walked only %d files in your whole home folder. That is far fewer than a Mac in use contains, so the result below is incomplete rather than clean.": "El análisis recorrió solo %d archivos en toda tu carpeta personal. Es mucho menos de lo que contiene un Mac en uso, así que el resultado de abajo está incompleto, no limpio.",
        "denied by macOS": "denegada por macOS",
        "came back empty — cannot tell denial from an empty folder": "volvió vacía — no se puede distinguir un bloqueo de una carpeta vacía",
        "Full Disk Access: not granted": "Acceso Total al Disco: no concedido",
        "Without Full Disk Access, macOS hides Desktop, Documents, Downloads, Movies, Music, Pictures and Library — which is exactly where large files live. It does this silently, returning empty folders rather than errors.": "Sin Acceso Total al Disco, macOS oculta Escritorio, Documentos, Descargas, Películas, Música, Imágenes y Library — que es justo donde viven los archivos grandes. Y lo hace en silencio, devolviendo carpetas vacías en vez de errores.",
        "These folders returned nothing and may be blocked: %@.": "Estas carpetas no devolvieron nada y podrían estar bloqueadas: %@.",
    ...
    static let fr: [String: String] = [
        ...
        // ── Cleanup risk ────────────────────────────────────────────────────
        "Caution": "Prudence",
        "%d file · click to filter": "%d fichier · cliquez pour filtrer",
        "%d files · click to filter": "%d fichiers · cliquez pour filtrer",
        "This volume": "Ce volume",
        "cloud providers": "les fournisseurs cloud",
        "Mail": "Mail",
        "Messages": "Messages",
        "group containers": "les conteneurs de groupe",
        "sandboxed app containers": "les conteneurs d'apps sandboxées",
        "Looking for other large folders…": "Recherche d'autres grands dossiers…",
        "Checking source and destination…": "Vérification de la source et de la destination…",
        "Copying %@…": "Copie de %@…",
        "%d file could not be read in the source, so the copy could not be verified. Nothing was moved.": "%d fichier n'a pas pu être lu à la source, la copie n'a donc pas pu être vérifiée. Rien n'a été déplacé.",
        "%d files could not be read in the source, so the copy could not be verified. Nothing was moved.": "%d fichiers n'ont pas pu être lus à la source, la copie n'a donc pas pu être vérifiée. Rien n'a été déplacé.",
        "Checking %d files…": "Vérification de %d fichiers…",
        "Publishing to the destination…": "Publication vers la destination…",
        "Testing reading and writing through the link…": "Test de lecture et d'écriture via le lien…",
        "Could not write the migration journal — nothing was moved. Check the disk.": "Impossible d'écrire le journal de migration — rien n'a été déplacé. Vérifiez le disque.",
        "Failed to publish AND the original could not be put back. It is safe in quarantine: %@": "Échec de la publication ET l'original n'a pas pu être remis en place. Il est en sécurité en quarantaine : %@",
        "Failed to create the link AND the original could not be put back. It is safe in quarantine: %@": "Échec de la création du lien ET l'original n'a pas pu être remis en place. Il est en sécurité en quarantaine : %@",
        "The link failed the test AND the original could not be put back. It is safe in quarantine: %@": "Le lien a échoué au test ET l'original n'a pas pu être remis en place. Il est en sécurité en quarantaine : %@",
        "The old copy could not be moved to the Trash and is still at %@.": "L'ancienne copie n'a pas pu aller à la Corbeille et se trouve toujours à %@.",
        "cleanup": "nettoyage",
        "trash": "corbeille",
        "app cache": "cache d'app",
        "offload": "déchargement",
        "Path protected by the system": "Chemin protégé par le système",
        "Outside the allowed scope": "Hors du périmètre autorisé",
        "The destination cannot be inside the source itself.": "La destination ne peut pas être à l'intérieur de la source.",
        "The source cannot be inside the destination.": "La source ne peut pas être à l'intérieur de la destination.",
        "Nothing to remove.": "Rien à supprimer.",
        "Use this folder": "Utiliser ce dossier",
        "Measuring %@…": "Mesure de %@…",
        "Evaluating %@…": "Évaluation de %@…",
        "%@ left (%d%%).": "Il reste %@ (%d%%).",
        "Preparing…": "Préparation…",
        "Cancelling…": "Annulation…",
        "Starting…": "Démarrage…",
        "Cancelled": "Annulée",
        "Emptying the Trash…": "Vidage de la Corbeille…",
        "Removing %@…": "Suppression de %@…",
        "Checking %@…": "Vérification de %@…",
        "Clearing %@…": "Vidage de %@…",
        "Uninstalling %@…": "Désinstallation de %@…",
        "Rolling back %@…": "Annulation de %@…",
        "Releasing %d quarantine…": "Libération de %d quarantaine…",
        "Releasing %d quarantines…": "Libération de %d quarantaines…",
        "Releasing %@…": "Libération de %@…",
        "Downloaded %@": "Téléchargé %@",
        "Safe": "Sûr",
        "Review": "À revoir",
        "Replace soon": "À remplacer bientôt",
        "Good": "Bonne",
        "Normal": "Normale",
        "No battery (desktop)": "Pas de batterie (ordinateur de bureau)",
        "Charging": "En charge",
        "Plugged in": "Sur secteur",
        "On battery": "Sur batterie",
        "%@ was quit.": "%@ a été quitté.",
        "Checking": "Vérification",
        "Copying": "Copie",
        "Failed": "Échec",
        "Rolled back": "Annulé",
        ...
        "Checking folder access…": "Vérification de l'accès aux dossiers…",
        "The scan probably did not see everything": "L'analyse n'a probablement pas tout vu",
        "The scan walked only %d files in your whole home folder. That is far fewer than a Mac in use contains, so the result below is incomplete rather than clean.": "L'analyse n'a parcouru que %d fichiers dans tout votre dossier personnel. C'est bien moins que ce que contient un Mac utilisé : le résultat ci-dessous est incomplet, pas propre.",
        "denied by macOS": "refusé par macOS",
        "came back empty — cannot tell denial from an empty folder": "revenu vide — impossible de distinguer un refus d'un dossier vide",
        "Full Disk Access: not granted": "Accès complet au disque : non accordé",
        "Without Full Disk Access, macOS hides Desktop, Documents, Downloads, Movies, Music, Pictures and Library — which is exactly where large files live. It does this silently, returning empty folders rather than errors.": "Sans accès complet au disque, macOS masque Bureau, Documents, Téléchargements, Films, Musique, Images et Library — c'est précisément là que vivent les gros fichiers. Et il le fait en silence, en renvoyant des dossiers vides plutôt que des erreurs.",
        "These folders returned nothing and may be blocked: %@.": "Ces dossiers n'ont rien renvoyé et sont peut-être bloqués : %@.",
        "Backups": "Sauvegardes",
        "Images": "Images",
        "Archives": "Archives",
        "Other": "Autres",
